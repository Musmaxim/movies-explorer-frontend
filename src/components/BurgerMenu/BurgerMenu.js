...
function BurgerMenu() {
  ...
  const menuOpenClassName = `${
    openMenu ? "menu__container menu__container_opened" : "menu__container"
  }`;
  const menuCheckboxClassName = `${
    openMenu ? " menu__btn menu__btn_checked" : "menu__btn"
  }`;
  ...
  return (
    <div className="menu">
      ...
      <div className={menuOpenClassName}>
        ...
        <NavLink to="/profile" className="menu__profile">
          Аккаунт
        </NavLink>
      </div>
    </div>
